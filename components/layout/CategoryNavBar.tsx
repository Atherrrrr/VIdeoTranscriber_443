...
const CategoryNavBar: React.FC = () => {
  ...
  const categories = [
    ...
    {
      name: "Electronics",
      icon: <IconDeviceDesktopAnalytics size={20} color={`${mainColor}`} />,
    },
    {
      name: "Kitchenware",
      icon: <IconToolsKitchen size={20} color={`${mainColor}`} />,
    },
    {
      name: "Instruments",
      icon: <IconMusic size={20} color={`${mainColor}`} />,
    },
    { name: "Bicycles", icon: <IconBike size={20} color={`${mainColor}`} /> },
    {
      name: "Games",
      icon: <IconDeviceGamepad2 size={20} color={`${mainColor}`} />,
    },
    {
      name: "Furniture",
      icon: <IconArmchair size={20} color={`${mainColor}`} />,
    },
  ];
